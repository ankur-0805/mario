 ...
 */
package com.mario.cockpits.setup;
...
import com.mario.cockpits.constants.MarioCockpitsConstants;
 ...
 */
@SystemSetup(extension = MarioCockpitsConstants.EXTENSIONNAME)
public class CockpitSystemSetup extends AbstractSystemSetup
{
	...
	public void createEssentialData(final SystemSetupContext context)
	{
		...
		{
			if (MediaManager.getInstance().getMediaFolderByQualifier(MarioCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER).size() < 1)
			{
				MediaManager.getInstance().createMediaFolder(MarioCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER,
						MarioCockpitsConstants.JASPER_REPORTS_MEDIA_FOLDER);
			}
			try
			{
				String prefix = null;
				...
				if (prefix != null){
					importImpexFile(context, "/mariocockpits/reportcockpit/import/" + prefix + "_jasperreports.impex");
				}
			}
