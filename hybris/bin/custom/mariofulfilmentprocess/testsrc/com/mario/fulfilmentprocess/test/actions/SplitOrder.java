 ...
 */
package com.mario.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(MarioFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(MarioFulfilmentProcessConstants.PARENT_PROCESS);
